    ...
    <>
      ...
      <section>
        <article>
          ...
          <ul>
            <li>Your mission is to get five tiles in a row either vertically or
            horizontally.</li>
          <li>You can play the game with two players and up to four players.</li>
          ...
          <li>
            Sometimes you may have to work together with others to
